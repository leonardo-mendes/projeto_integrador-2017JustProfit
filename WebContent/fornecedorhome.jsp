							...
							<div role="tabpanel" class="tab-pane active" id="informacoes"><br>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form id="formedit1">
									  ...
									  <div class="form-group">
									    <label for="codforn">Código de Fornecedor</label>
									    <input type="text" class="form-control" id="codForn" placeholder="Código de Fornecedor" disabled="disabled">
									  </div>		
									  <div class="form-group">
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form id="formedit2">
									  ...
									  <div class="form-group">
									    <label for="qtdvend">Quantidade de Vendedores</label>
									    <input type="text" class="form-control" id="qtdvend"" placeholder="Quantidade de Vendedores" disabled="disabled">
									  </div>
									</form>
								</div>
							</div>
